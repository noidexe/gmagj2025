...
var sky_lut := load("res://shaders/clouds/sky_lut.tres")
var transmittance_tex := load("res://shaders/clouds/transmittance_lut.tres")
...
func _init():
	...
	sky_material.shader = preload("res://shaders/clouds/clouds.gdshader")
...
func _create_noise_uniform_set() -> RID:
	...
	var large_scale_noise = preload("res://shaders/clouds/perlworlnoise.tga")
	...
	var small_scale_noise = preload("res://shaders/clouds/worlnoise.bmp")
	...
	var weather_noise = preload("res://shaders/clouds/weather.bmp")
...
func _initialize_compute_code(p_texture_size):
	...
	# Create our shader
	var shader_file = load("res://shaders/clouds/clouds.glsl")
